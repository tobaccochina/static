...
Cms.swfUploadFile = function (name, settings) {
    ...
    settings.upload_url = settings.upload_url || CTX + ADMIN_LOP + "/core/upload_file.do?_site=" + ($.cookie("_site") || "");
...
Cms.swfUploadVideo = function (name, settings) {
    ...
    settings.upload_url = settings.upload_url || CTX + ADMIN_LOP + "/core/upload_video.do?_site=" + ($.cookie("_site") || "");
    settings.upload_success_handler = function (file, serverData) {
        doUploadSuccess(file, serverData, this);
        var data = $.parseJSON(serverData);
        $("#" + name).val(data.fileUrl);
...
Cms.swfUploadDoc = function (name, settings) {
    ...
    settings.upload_url = settings.upload_url || CTX + ADMIN_LOP + "/core/upload_doc.do?_site=" + ($.cookie("_site") || "");
    settings.upload_success_handler = function (file, serverData) {
        doUploadSuccess(file, serverData, this);
        var data = $.parseJSON(serverData);
        $("#" + name).val(data.fileUrl);
...
Cms.swfUploadImage = function (name, settings) {
    ...
    settings.upload_url = settings.upload_url || CTX + ADMIN_LOP + "/core/upload_image.do?_site=" + ($.cookie("_site") || "");
...
Cms.jfUploadFile = function (name, settings) {
    ...
    settings.url = settings.url || CTX + ADMIN_LOP + "/core/upload_file.do?_site=" + ($.cookie("_site") || "");
    settings.maxNumberOfFiles = settings.maxNumberOfFiles || 1;
    if (settings.file_size_limit && settings.file_size_limit > 0) {
        settings.maxFileSize = settings.file_size_limit * 1024;
    }
...
Cms.jfUploadVideo = function (name, settings) {
    settings = settings || {};
    settings.dataType = 'json';
    settings.url = settings.url || CTX + ADMIN_LOP + "/core/upload_video.do?_site=" + ($.cookie("_site") || "");
    settings.maxNumberOfFiles = settings.maxNumberOfFiles || 1;
    if (settings.file_size_limit && settings.file_size_limit > 0) {
        settings.maxFileSize = settings.file_size_limit * 1024;
    }
...
Cms.jfUploadFlash = function (name, settings) {
    settings = settings || {};
    settings.dataType = 'json';
    settings.url = settings.url || CTX + ADMIN_LOP + "/core/upload_flash.do?_site=" + ($.cookie("_site") || "");
    settings.maxNumberOfFiles = settings.maxNumberOfFiles || 1;
    if (settings.file_size_limit && settings.file_size_limit > 0) {
        settings.maxFileSize = settings.file_size_limit * 1024;
    }
...
Cms.jfUploadDoc = function (name, settings) {
    settings = settings || {};
    settings.dataType = 'json';
    settings.url = settings.url || CTX + ADMIN_LOP + "/core/upload_doc.do?_site=" + ($.cookie("_site") || "");
    settings.maxNumberOfFiles = settings.maxNumberOfFiles || 1;
    if (settings.file_size_limit && settings.file_size_limit > 0) {
        settings.maxFileSize = settings.file_size_limit * 1024;
    }
...
Cms.jfUploadImage = function (name, settings) {
    settings = settings || {};
    settings.dataType = 'json';
    settings.url = settings.url || CTX + ADMIN_LOP + "/core/upload_image.do?_site=" + ($.cookie("_site") || "");
    settings.maxNumberOfFiles = settings.maxNumberOfFiles || 1;
    if (settings.file_size_limit && settings.file_size_limit > 0) {
        settings.maxFileSize = settings.file_size_limit * 1024;
    }
...
Cms.imgCrop = function (action, name) {
    ...
    var url = (action.indexOf("?") != -1 ? action + "&" : action + "?") + "d=" + new Date() * 1 + "&src=" + $("#" + name).val() + "&targetWidth=" + $("#w_" + name).val() + "&targetHeight=" + $("#h_" + name).val() + "&targetFrame=" + frameId + "&name=" + name;
